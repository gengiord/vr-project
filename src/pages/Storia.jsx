...
const acts = [
  ...
  },
  {
    ...
    details: [
      ...
      { icon: '✨', label: 'Avvicinamento', text: "Un'animella dorata stilizzata — forma geometrica astratta — si avvicina ad ogni pietra lanciata, simbolo di connessione." },
    ],
    frames: [
  ...
  },
  {
    ...
    color: '#3a6b8c',
    details: [
      { icon: '🤝', label: 'Il Silenzio Condiviso', text: "Mare calmo e luminoso. Animella stilizzata a 2m. Due presenze faccia a faccia. 10-15s di silenzio profondo." },
      ...
      { icon: '⭐', label: 'La Scelta', text: "Una sfera dorata appare in grembo. Se il giocatore la alza, l'animella si dissolve — contorni luminosi aperti, particelle, riflessi sull'acqua. Resta un punto di luce." },
    ],
    frames: [
      { num: '13', title: 'Faccia a faccia', desc: "Tutte le pietre lanciate. L'animella è di fronte al giocatore, a 2 metri. Due presenze faccia a faccia, sul mare, sotto le stelle. Animella dorata stilizzata, forma geometrica astratta senza volto, sospesa sul mare. Semplice, coerente con lo stile low poly del progetto. Solo due presenze.", voice: '"Non tutto ciò che lasci andare si perde." — "A volte, è proprio lasciando andare... che qualcuno torna." — "Non devi parlare. Non devi fare nulla. Sii qui."' },
