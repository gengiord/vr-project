...
const PHASES = [
  {
    ...
    steps: [
      ...
      },
      {
        ...
        status: 'upcoming',
        desc: 'Redazione del GDD completo: struttura degli atti, meccaniche di interazione hand tracking, principi di design emotivo, specifiche tecniche per Meta Quest.',
        tasks: [
      ...
      },
      {
        ...
        title: 'Storyboard e Moodboard',
        status: 'upcoming',
        desc: 'Creazione dei 20 frame dello storyboard frame-by-frame. Definizione delle palette cromatiche per ogni atto. Reference visivi da Journey, Gris, Abzu.',
        tasks: [
          '20 frame storyboard generati con Gemini AI',
      ...
      },
      {
        ...
        title: 'Concept Art, Audio e Asset Planning',
        status: 'upcoming',
        desc: 'Generazione concept art con Meshy AI e Gemini. Creazione voce narrante con ElevenLabs. Selezione e creazione musica, SFX e audio spaziale per ogni ambiente.',
        tasks: [
